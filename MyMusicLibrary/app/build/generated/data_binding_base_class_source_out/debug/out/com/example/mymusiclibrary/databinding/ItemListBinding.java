...
public final class ItemListBinding implements ViewBinding {
  ...
  private ItemListBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView albumTitleTextView) {
  ...
  public static ItemListBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.albumTitleTextView;
      TextView albumTitleTextView = ViewBindings.findChildViewById(rootView, id);
      if (albumTitleTextView == null) {
        break missingId;
      }

      return new ItemListBinding((ConstraintLayout) rootView, albumTitleTextView);
    }
