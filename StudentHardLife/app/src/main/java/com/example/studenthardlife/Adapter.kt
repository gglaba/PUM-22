...
class Adapter(private val dbHandler: DBHandler) :
    ...
    class TaskViewHolder(itemView: View) :
        ...
        private val taskName: TextView = itemView.findViewById(R.id.taskID)
        private val courseName: TextView = itemView.findViewById(R.id.courseID)
        fun bind(item: Task) {
            taskName.text = item.taskName
            courseName.text = item.courseName
            itemView.setOnClickListener{
                val action = OverviewFragmentDirections.actionTaskOverviewFragmentToTaskDetailsFragment(taskId = item.id.toString())
